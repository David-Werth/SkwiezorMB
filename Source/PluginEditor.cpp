                                   ...
                                   bool shouldDrawButtonAsDown)
{
    ...
    else
    {
        ...
        g.setColour(buttonIsOn ? juce::Colours::blue : juce::Colours::white);
...
ratioSlider(nullptr, "")
{
    ...
    makeAttachmentHelper(attackSliderAttachment, Names::Attack_Low_Band, attackSlider);
    makeAttachmentHelper(releaseSliderAttachment, Names::Release_Low_Band, releaseSlider);
    makeAttachmentHelper(thresholdAttachment, Names::Threshold_Low_Band, thresholdSlider);
    makeAttachmentHelper(ratioSliderAttachment, Names::Ratio_Low_Band, ratioSlider);
